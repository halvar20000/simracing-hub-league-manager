            ...
            {drivers.map((d, i) => (
              ...
              >
                ...
                {rounds.map((r) => {
                  ...
                  // DSQ marker only when ALL of the driver's races in the round
                  // were DSQ. If they finished at least one race cleanly
                  // (CLASSIFIED/DNF → `entered`), they showed up, so no DSQ mark.
                  const isDsq =
