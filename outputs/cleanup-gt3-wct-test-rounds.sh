#!/usr/bin/env bash
# Delete the test rounds (1 and 2) from the most recent CAS GT3 WCT season,
# renumber the remaining rounds to start from 1, and rename the season.
...
cat > scripts/cleanup-gt3-wct-test-rounds.ts <<'EOF'
...
npx tsx scripts/cleanup-gt3-wct-test-rounds.ts
