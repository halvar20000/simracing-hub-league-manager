#!/usr/bin/env bash
# Add the 12 rounds of the CAS GT3 WCT 12th Season to the most recent
# CAS GT3 WCT season, based on the schedule poster.
# Race day: Tuesday, 18:00 CET (winter) / 18:00 CEST (summer).
...
cat > scripts/add-gt3-wct-rounds.ts <<'EOF'
...
echo "  npx tsx scripts/add-gt3-wct-rounds.ts"
