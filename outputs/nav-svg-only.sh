#!/usr/bin/env bash
# Drop the duplicate wordmark text from the nav — the SVG logo already
# contains "SIMRACING-HUB" and "League Manager", so we just show the SVG.
...
echo "Done. Nav now shows just the SVG logo (which contains the wordmark + tagline)."
echo "Refresh the browser tab."
