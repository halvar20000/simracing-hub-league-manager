#!/usr/bin/env bash
# Enrich the public league page with: stats banner, active season hero
# (next-race countdown), latest results across the league, past champions
# (hall of fame), plus the existing seasons grid.
set -euo pipefail
...
EOF
echo "Wrote src/app/leagues/[slug]/page.tsx"

git add -A
git commit -m "Public league page: stats banner, active-season hero, latest results, hall of fame"
git push
echo ""
