#!/usr/bin/env bash
# Force the corner logos on league detail + season detail pages to exactly 20px.
...
# Season detail — only the corner logo block, kept everything else identical
...
echo "Done. Both subpage corner logos forced to h-5 (20px)."
echo "Hard-refresh in browser: Cmd+Shift+R"
