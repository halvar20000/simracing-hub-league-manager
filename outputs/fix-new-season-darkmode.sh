...
cat > 'src/app/admin/leagues/[slug]/seasons/new/page.tsx' <<'TSX'
...
TSX
echo "[+] Rewrote src/app/admin/leagues/[slug]/seasons/new/page.tsx in dark theme."
...
git add -A
git commit -m "Admin new-season page: convert to dark zinc theme so text is readable on the dark layout"
git push
echo ""
