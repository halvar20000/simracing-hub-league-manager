#!/usr/bin/env bash
# Register all 45 drivers from the "Anmeldung WCT Season 12" Google Sheet
# into the most recent CAS GT3 WCT season. Sets Pro/Am, team, start number,
# and marks every registration as APPROVED.
...
cat > scripts/register-wct-drivers.ts <<'EOF'
...
npx tsx scripts/register-wct-drivers.ts
