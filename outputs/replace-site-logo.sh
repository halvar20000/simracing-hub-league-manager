...
# ============================================================================
# Locate the new logo image saved by the user
# ============================================================================
SRC="${1:-$HOME/Downloads/cas-league-logo.png}"
if [ ! -f "$SRC" ]; then
  echo "!!! New logo not found at: $SRC"
  echo ""
  echo "    Save the attached image first, then run this again."
  echo "    Default expected location: ~/Downloads/cas-league-logo.png"
  echo "    Or pass the path:  bash replace-site-logo.sh /path/to/file.png"
  exit 1
fi
...
# ============================================================================
# 1. Copy as the new site logo (replaces SimRacing-Hub-style site-logo.svg)
#    Also refresh the OG card logo so socials show the same image.
# ============================================================================
echo ""
